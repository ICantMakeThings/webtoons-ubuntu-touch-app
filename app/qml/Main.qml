...
// CSS ting to make bg black in reader mode
property string readerCss: "
(function() {
    var style = document.createElement('style');
    style.innerHTML = `
        html, body, #viewerContainer, .viewer, .viewer_container, .container, .scroll-wrapper {
            margin: 0 !important;
            padding: 0 !important;
            background: #000 !important;
            /* REMOVE overflow-x:hidden or any scroll blocking */
        }
